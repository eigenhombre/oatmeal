...
https://github.com/eigenhombre/oatmeal/actions/workflows/build.yml/badge.svg?branch=master]]
[[https://github.com/eigenhombre/oatmeal/actions/workflows/build.yml/badge.svg?branch=master][https://github.com/eigenhombre/oatmeal/actions/workflows/build.yml]]
...
(On MacOS; your mileage may vary on other platforms.) First install Java and [[https://leiningen.org/][Leiningen]].  Then =brew install sbcl=.
