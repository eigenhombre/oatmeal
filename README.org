...
@@html:<a href='https://github.com/eigenhombre/oatmeal/actions/workflows/build.yml'><img src='https://github.com/eigenhombre/oatmeal/actions/workflows/build.yml/badge.svg?branch=master'/></a>@@
